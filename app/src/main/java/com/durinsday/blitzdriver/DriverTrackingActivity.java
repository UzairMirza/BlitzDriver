...
import static com.durinsday.blitzdriver.Common.Common.mLastLocation;
...
public class DriverTrackingActivity extends FragmentActivity implements OnMapReadyCallback,
        ...
        btnStartTrip.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (btnStartTrip.getText().equals("START TRIP")){
                    ...
                    calculateFare(pickupLocation,Common.mLastLocation);
                }
            }
        });
                    ...
                    .enqueue(new Callback<String>() {
                        ...
                        public void onResponse(Call<String> call, Response<String> response) {
                            try {
                                ...
                                Intent intent = new Intent(DriverTrackingActivity.this, DriverTripDetailActivity.class);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        riderMarker = mMap.addCircle(new CircleOptions()
                ...
                .strokeWidth(5.0f));
        mMap.addMarker(new MarkerOptions().position(new LatLng(riderLat, riderLng))
                .title("Rider")
...
//        Sender sender = new Sender(token.getToken(), notification);
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String, String>>>> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            mDialog.setMessage("Kindly Wait");
            mDialog.show();
        }
